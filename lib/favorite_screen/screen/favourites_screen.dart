                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return FutureBuilder<Uint8List?>(
                            future: VideoThumbnail.thumbnailData(
                              video: favorites?.results?.videos?[index].url ?? '',
                              // Provide a default value for the video URL
                              imageFormat: ImageFormat.JPEG,
                              maxWidth: 100,
                              quality: 100,
                              timeMs: 1000, // Time in milliseconds for the second frame
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => VideoPlayerScreen(videoUrl: favorites?.results?.videos?[index].url ?? '', titleOfVideo: favorites?.results?.videos?[index].id?.title??'',),
                                        ),
                                      );
                                    },
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                favorites?.results?.videos?[index].id?.title ?? '',
                                              ...
                                              Text(
                                                favorites?.results?.videos?[index].id?.createdAt ?? '',
                                                maxLines: 1,
                                            ...
                                            itemBuilder: (BuildContext context) => <PopupMenuEntry>[
                                              PopupMenuItem(
                                                ...
                                                onTap: () {
                                                  FileDownloader.downloadFile(
                                                    url: favorites!.results!.videos![index].url!,
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    SizedBox(width: 2.w), // Adjust the width as needed
                                                    Text(
                                                      "Download",
                                                      style: TextStyle(
                                                        color: Colors.black,
                                              ...
                                              PopupMenuItem(
                                                onTap: () async {
                                                  ...
                                                  final videoUrl = favorites!.results!.videos![index].url!;
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    SizedBox(width: 3.w), // Adjust the width as needed
                                                    Text(
                                                      "share",
                                                      style: TextStyle(
                                                        color: Colors.black,
